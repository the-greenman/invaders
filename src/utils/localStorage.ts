...
export class LocalStorage {
  ...
  static getSettings(): GameSettings {
    try {
      ...
      if (!data) return { muted: false, difficulty: 'normal', controllerFireButton: 3, controllerBackButton: 1, controllerStartButton: 11 };
      const parsed = JSON.parse(data);
      return { muted: false, difficulty: 'normal', controllerFireButton: 3, controllerBackButton: 1, controllerStartButton: 11, ...parsed };
    } catch (error) {
      console.error('Error parsing settings:', error);
      return { muted: false, difficulty: 'normal', controllerFireButton: 3, controllerBackButton: 1, controllerStartButton: 11 };
    }
  }
